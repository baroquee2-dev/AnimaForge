...
const UserListing: React.FC<CharacterListingProps> = ({ user }) => {
    ...
    const handleDeleteCard = async (close: () => void) => {
        close()
        Alert.alert({
            title: t('userManager.deleteTitle'),
            description: t('userManager.deleteDesc', { name: user.name }),
            buttons: [
                { label: t('common.cancel') },
                {
                    label: t('userManager.deleteConfirm'),
                    onPress: async () => {
    ...
    const handleCloneCard = (close: () => void) => {
        Alert.alert({
            title: t('userManager.cloneTitle'),
            description: t('userManager.cloneDesc', { name: user.name }),
            buttons: [
                { label: t('common.cancel') },
                {
                    label: t('userManager.cloneConfirm'),
                    onPress: async () => {
                        close()
