...
To get started, simply add your custom colors to [exampleTheme.json](https://github.com/baroquee2-dev/MiseChat/blob/dev/docs/exampleTheme.json), then import them in the `Settings` > `Change Theme` > `Gear Icon` > `Import`
